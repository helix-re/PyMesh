...
void init_Lattice2D(py::module &m) {
    py::class_<Lattice2D, std::shared_ptr<Lattice2D> >(m, "Lattice2D")
        ...
        .def("GetVertexToVertexConnections", &Lattice2D::GetVertexToVertexConnections)
        .def("GetVertexToEdgeConnections", &Lattice2D::GetVertexToEdgeConnections)
        .def("GetEdgeToEdgeConnections", &Lattice2D::GetEdgeToEdgeConnections)
